                                        ...
                                        <div class="au-message__item-inner">
                                            <div class="au-message__item-text">
                                                <div class="avatar-wrap">
                                                    <div class="avatar">
                                                        <img src="{{ asset('vendor/select2/select2.min.css') }}images/icon/avatar-02.jpg" alt="John Smith">
                                                    </div>
                                                </div>
                                                <div class="text">
                                    ...
                                    <div class="au-message__item">
                                        <div class="au-message__item-inner">
                                            <div class="au-message__item-text">
                                                <div class="avatar-wrap online">
                                                    <div class="avatar">
                                                        <img src="{{ asset('vendor/select2/select2.min.css') }}images/icon/avatar-04.jpg" alt="Michelle Sims">
                                                    </div>
                                                </div>
                                                <div class="text">
