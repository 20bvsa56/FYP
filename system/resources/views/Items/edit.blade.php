    ...
    <div style="alignment: center; margin-left: 100px; margin-right: 100px;">
        <form action="{{route('itemUpdate',$item->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" placeholder="Enter food item title" value="{{$item->title}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="price" placeholder="Enter food item price" value="{{$item->price}}">
                <small class="form-text text-muted">Ex: Special, Regular etc.</small>
            </div>
            <div class="form-group">
                <label for="Description">Description</label>
                <input type="text" class="form-control" name="description" placeholder="Enter food item description" value="{{$item->description}}">
                <small class="form-text text-muted">Ex: Special, Regular etc.</small>
            </div>
            <div class="form-group">
                <label>Image</label>
            ...
            <div class="form-group">
                <label class="radio-inline">
                    <input type="radio" id="smt-fld-1-2" value="Special" name="type" value="{{$item->type}}">Special</label>

                <label class="radio-inline">
                    <input type="radio" id="smt-fld-1-3" value="Regular" name="type" value="{{$item->type}}" checked>Regular</label>
            </div>
